...
function RegisterCompany() {
    ...
    ***/
    ...
    const sendData = async (data: FormData) => {
        ...
        if (user['name'] && user['siren'] && user['phone'] && user['email'] && user['password']) {
            ...
            if (strength && checkEmailFormat(user['email'] as string) && checkPhoneFormat(user['phone'] as string)) {
                // call RegisterCompany service
                const response_status = AuthenticationService.registerCompanies(user);
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log(name, siren, phone, email, password, strength, emailFormat, phoneFormat);
        sendData(data);
    };
                    ...
                    <Box
                        ...
                        <Grid container spacing={2} justifyContent="center" flexDirection="column">
                            ...
                            <Grid item xs={12}>
                                ...
                                />
                                {/* If siren is empty, display an error message */}
                                {!siren && (
                                    <Alert severity="error">
                        ...
                        <Grid container justifyContent='flex-end' sx={{ mb: 4 }}>
                            <Grid item sx={{ textAlign: 'center', width: '100%'}}>
                                <Link href='/companies/login' variant='body2'>
