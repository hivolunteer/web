...
const MissionDetailsHeader = (props: { mission: Mission, association: Association, location: string }) => {

    const { mission, association, location } = props;

    return (
        <div className='mission-details-header'
            style={{
                backgroundImage: `url(${(mission?.picture)? mission?.picture : association?.profile_picture})`,
